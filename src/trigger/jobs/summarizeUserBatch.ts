...
- country — только страна, без города, на русском языке.  
  ❗ Если это Россия, всегда указывай строго: **"Россия"**.  
  ❗ Не используй "РФ", "Российская Федерация", "Россия, Москва" — только "Россия".  
  ❗ Никогда не оставляй пустым. Если страна не указана напрямую, делай обоснованное предположение по языку, лексике, культурному контексту.
